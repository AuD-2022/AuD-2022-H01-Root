...
public class PartitionListsAsCopyRecursivelyTests {
    ...
    private static final String FULLY_QUALIFIED_METHOD_NAME = "h01.DoubleListOfListsProcessor#"
        + "partitionListsAsCopyRecursively(ListItem, double)";
    ...
    public void testWithEmptyMainList(ListItem<ListItem<Double>> listOfLists) {
        ...
        assertTrue(ListItemUtils.deepEquals(Tutor_DoubleListOfListsProcessor.partitionListsAsCopyRecursively(copyExpected, 100),
                DoubleListOfListsProcessor.partitionListsAsCopyRecursively(copyActual, 100)),
