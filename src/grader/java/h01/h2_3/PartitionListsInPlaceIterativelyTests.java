...
public class PartitionListsInPlaceIterativelyTests {
    ...
    public void testWithEmptyMainList(ListItem<ListItem<Double>> listOfLists) {
        ...
        assertTrue(ListItemUtils.deepEquals(Tutor_DoubleListOfListsProcessor.partitionListsInPlaceIteratively(copyExpected, 100),
                DoubleListOfListsProcessor.partitionListsInPlaceIteratively(copyActual, 100)),
